...
class BrokerSpot:
    ...
    def _create_user_message_handler(self) -> Callable[..., None]:
    ...
    def _create_ticker_message_handler(self) -> Callable[..., None]:
    ...
    def _create_kline_message_handler(self) -> Callable[..., None]:
