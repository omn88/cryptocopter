...
class PositionHandler:
    ...
    # async def open_sell_position(self, config: HPConfig, state_info: StateInfo, buy_orders: List[Order]) -> None:
    #     self.order_handler.prepare_sell_orders(config=config, buy_orders=buy_orders)
    #     self.orders = await self.order_handler.create_orders(
    #         side=state_info.side, orders=self.orders, symbol_info=config.symbol_info
    #     )
    #     self.state_info.next_monitor_time = (
